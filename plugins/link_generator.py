...
from colored_reply import send_colored, btn_success, btn_primary, btn_danger
...
@Bot.on_message(filters.private & is_admin & filters.command("batch"))
async def batch(client: Client, message: Message):
    ...
    await send_colored(
        ...
        chat_id=second_message.chat.id,
        text=f"<b>Link Sharing File Berhasil Di Buat:</b>\n\n{link}",
        keyboard=link_keyboard,
        reply_to_message_id=second_message.id,
    )


@Bot.on_message(filters.private & is_admin & filters.command("genlink"))
async def link_generator(client: Client, message: Message):
    ...
    await send_colored(
        bot_token=client.bot_token,
        chat_id=channel_message.chat.id,
        text=f"<b>Link Sharing File Berhasil Di Buat:</b>\n\n{link}",
        keyboard=link_keyboard,
        reply_to_message_id=channel_message.id,
    )
